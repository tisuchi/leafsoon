...
return [
	...
	'DATE_FIELDS_CANDIDATE'     =>'date,data,datahora,datetime,tanggal,tgl,created_at,updated_at,deleted_at',

	'EMAIL_FIELDS_CANDIDATE'	=>'email,mail,email_address',

	'PHONE_FIELDS_CANDIDATE'	=>'phone,phonenumber,tel,phone_number,telp,hp,no_hp,no_telp',
